...
export default function NiveauPage() {
  ...
  return (
    <div className="min-h-screen bg-gray-50 dark:bg-gray-950">
      ...
      {/* Header compact */}
      <div className="bg-white dark:bg-gray-900 border-b border-gray-200 dark:border-gray-800 text-gray-900 dark:text-white pt-16 pb-4 px-4">
        <div className="max-w-4xl mx-auto">
          <Link href="/apprendre" className="inline-flex items-center gap-1 text-green-600 hover:text-green-700 mb-1 text-xs transition-colors">
            <ChevronLeft className="h-3 w-3" /> Tous les niveaux
          </Link>
          <h1 className="text-lg font-bold">{niveau.nom}</h1>
          <p className="text-gray-500 dark:text-gray-400 text-xs">{niveau.matieres?.length || 0} matières disponibles</p>
        </div>
      </div>
