      ...
      <div className="bg-white rounded-2xl shadow-sm border border-gray-100 p-10 max-w-md w-full text-center">
        ...
        {status === 'success' && (
          <>
            ...
            <Link href="/dashboard" className="inline-block bg-emerald-600 text-white px-6 py-2.5 rounded-lg font-medium hover:bg-emerald-700 transition">
        ...
        {status === 'error' && (
          <>
            ...
            <div className="flex gap-3 justify-center">
              <Link href="/check-email" className="inline-block bg-emerald-600 text-white px-5 py-2.5 rounded-lg font-medium hover:bg-emerald-700 transition text-sm">
                Renvoyer l'e-mail
              </Link>
